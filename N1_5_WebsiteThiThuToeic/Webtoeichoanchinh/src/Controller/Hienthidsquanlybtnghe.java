...
public class Hienthidsquanlybtnghe extends HttpServlet {
			...
			throws ServletException, IOException 
	{
		try 
		{
			...
			List<Listenexercise> list = QuanlybtngheDAO.Hienthidsbtnghe(request, pageid, count, conn);
			
			
			int sumrow = QuanlybtngheDAO.Countrow(conn);
			...
			request.setAttribute("danhsachqlbtnghe",list);
